        ...
        <Tabs>
            <div>
                <div className="mx-auto grid grid-cols-12 gap-4 bg-zinc-50 p-1">
                    <div className="col-span-12 rounded-lg border border-gray-400 bg-gray-200 p-10 sm:col-span-3 flex items-start">
                        {/* Sidebar */}
                    ...
                    <div className="col-span-12 rounded-lg border border-gray-500 bg-gray-200 p-1 sm:col-span-9">
                        ...
                        <TabPanel>
                            <div className="w-10/12 m-10 m-auto bg-white border border-gray-200 rounded-lg shadow p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
                                <form className="space-y-6" action="#">
                                    <h5 className="text-xl font-medium text-gray-900 dark:text-white">
                                        Change Password
                                    </h5>
